...
The journals 'Space Weather', 'Journal of Geophysical Research/Space
Physics', \
 'Geophysical Research Letters', 'Radio Science', 'Earth & Space
Science', 'Solar\
 Physics', 'Journal of Atmospheric and Solar-Terrestrial Physics' and
'Advances in \
 Space Research' were searched for acknowledgments of services developed
and \
 supported by NASA/Goddard's Space Physics Data Facility (SPDF).

*Keywords searched and the number of occurrences across the eight
journals:*
...
OMNI and/or OMNIWeb were referenced in 371 papers\
 ...
 COHOWeb or Helioweb or ATMOweb or ftpbrowser was referenced in 6
papers\
...
2021**
    ...
    Sample usage= CINDI instrument onboard C/NOFS (https:// cdaweb .gsfc.nasa.gov). Finally,
    we are grateful 

    1. Title=Comparing three approaches to the inducing source setting for the ground
    ...
    Sample usage= input for this run (http:// omniweb .gsfc.nasa.gov). We are grateful to 
    Sample usage= from the Earths center. 1-min OMNI solar wind data have been 

    1. Title=Distributions of Ion Density Irregularities and Their Gradients Inside Low
    ...
    Keywords found: CDAWeb
    Sample usage= available in https:// cdaweb .gsfc.nasa.gov/index.html/. The C/NOFS PLP data

    1. Title=A Peculiar ICME Event in August 2018 Observed With the Global Muon Detector
    Network
    ...
    Sample usage= 24 and 27, 2018 (https:// omniweb .gsfc.nasa.gov/ow.html). Both the magnetic
    field 

    1. Title=Reconstruction of the Radiation Belts for Solar Cycles 17 - 24 (1933 - 2017)
    ...
    Keywords found: CDAWeb
    Sample usage= mission were found at https:// cdaweb
    .gsfc.nasa.gov/pub/data/crres/particle_mea/. GOES measurements were obtained 

    1. Title=Why are ELEvoHI CME arrival predictions different if based on STEREO A or STEREO
    ...
    1. Title=CME Magnetic Structure and IMF Preconditioning Affecting SEP Transport
    ...
    1. Title=Nighttime magnetic perturbation events observed in Arctic Canada: 3. Occurrence
    ...
    Sample usage= at https:// cdaweb .sci.gsfc.nasa.gov/index.html/. The SME index is 
    ...
    1. Title=Ionospheric disturbances over the Indian sector during 8 September 2017
    ...
    (https://cdaweb.gsfc.nasa.gov/index.html/). Additional information derived from 
    Sample usage= 5 min time resolution by OMNI database and region, time-shifted to 

    1.  Title=Application of a multi layer artificial neural network in a 3 D global electron
    ...
    Sample usage= (https:// omniweb .gsfc.nasa.gov/). (https://omniweb.gsfc.nasa.gov/). 
    ...
    1.  Title=A deep learning model for the thermospheric nitric oxide emission
    ...
    1.  Title=Prediction of Dynamic Plasmapause Location Using a Neural Network
    ...
    1.  Title=The geomagnetic Kp index and derived indices of geomagnetic activity
    ...
    Keywords found: OMNIWeb, OMNI
    Sample usage= NASA OMNI web database (http:// omniweb .gsfc.nasa.gov/). The NOAA nowcast
    Kp
    Sample usage= = 180. We used the OMNI 1-min solar wind data estimated

    1.  Title=The Impact of Solar Activity on Forecasting the Upper Atmosphere via
    ...
    Keywords found: OMNIWeb, OMNI
    Sample usage= (CH-ME-2-PLPT). The NASA/OMNI database ( omniweb .gsfc.nasa.gov) provided
    the (CH-ME-2-PLPT). The
    Sample usage= and marked in orange. Source: OMNI data available on omni- values

    1.  Title=Long Short Term Memory Neural Network for Ionospheric Total Electron Content
    ...
    (https://omniweb.gsfc.nasa.gov/form/dx1.html). The IRI-2016 and
    Sample usage= index F10.7 was downloaded from SPDF potsdam.de/en/kpindex/). The solar
    activity index

    1.  Title=Dynamics of Electron Flux in the Slot Region and Geomagnetic Activity
    ...
    Sample usage= the NASA online tool https:// omniweb .gsfc.nasa.gov/vitmo/cgm.html epoch
    2000 with use
    Sample usage= the NASA online tool https://omniweb.gsfc.nasa.gov/ vitmo /cgm.html epoch
    2000 with use

    1.  Title=A Nonlinear System Science Approach to Find the Robust Solar Wind Drivers of the
    ...
    1.  Title=The determination of satellite orbital decay from POD data during geomagnetic
    storms
    Authors=Ruoxi Li; Jiuhou Lei;
    article=2020SW002664; doi=10.1029/2020SW002664; pubdate=02 April 2021
    Keywords found: OMNIWeb
    Sample usage= Kp indices are available from OMNIWeb (https://omniweb.gsfc.nasa.gov/). from
    OMNIWeb (https://omniweb.gsfc.nasa.gov/).

    1.  Title=ASHLEY: A new empirical model for the high latitude electron precipitation and
    electric field
    ...
    Sample usage= can be downloaded from NASA SPDF OMNIWeb (https://omniweb.gsfc.nasa.gov).
    The DMSP can

    1.  Title=Toward a next generation particle precipitation model: Mesoscale prediction
    ...
    Sample usage= Satellite Program (DMSP) satellites https:// cdaweb
    .gsfc.nasa.gov/pub/data/dmsp/; (Redmon et al., (DMSP)
    ...
    1.  Title=Using Gradient Boosting Regression to Improve Ambient Solar Wind Model
    Predictions
    ...
    Sample usage= solar wind speed observations: https:// spdf
    .gsfc.nasa.gov/pub/data/omni/low_res_omni/. Jupyter Notebook used to

    1.  Title=Latitudinal, Diurnal and Seasonal Variations in the Accuracy of an RTK
    ...
    1.  Title=FTA: A Feature Tracking Empirical Model of Auroral Precipitation
    ...
    Sample usage= Data Facility's OMNIWeb service (https:// spdf .gsfc.nasa.gov/). The Polar
    UVI NASA/GSFC's
    Sample usage= were provided by the NASA/GSFC's Space Physics Data Facility 's OMNIWeb
    service (https://spdf.gsfc.nasa.gov/). The

    1.  Title=Deep Neural Networks With Convolutional and LSTM Layers for SYM-H and ASY-H
    Forecasting
    ...
    Keywords found: CDAWeb, OMNIWeb, OMNI
    Sample usage= and ASY-H indices from https:// cdaweb .gsfc.nasa.gov/index.html (King,
    2005). The indices
    ...
    1.  Title=Extreme low-latitude TEC enhancement and GPS Scintillation at dawn
    ...
    Keywords found: CDAWeb, OMNIWeb, OMNI
    Sample usage= indices are available via https:// cdaweb .sci.gsfc.nasa.gov/pub/data/omni/.
    High-rate data used to
    Sample usage= and geomagnetic indices from the OMNIweb database. The time period Solar
    Sample usage= indices are available via https://cdaweb.sci.gsfc.nasa.gov/pub/data/ omni /.
    High-rate data used to

    1.  Title=Data-Driven Forecasting of Low-Latitude Ionospheric Total Electron Content (TEC)
    ...
    1.  Title=Solar Wind Speed Prediction with Two-Dimensional Attention Mechanism
    ...
    1.  Title=Geosynchronous magnetopause crossings and their relationships with magnetic
    ...
    Sample usage= wind parameters from OMNI (https:// omniweb .gsfc.nasa.gov/) and consider
    the time
    Sample usage= al., 2010) and hourly averaged OMNI data and find The paper

    1.  Title=A Bayesian inference-based empirical model for scintillation indices for
    high-latitude
    ...
    1.  Title=Improving Solar Wind Forecasting using Data Assimilation
    ...
    Sample usage= NIWeb portal at https:// omniweb .gsfc.nasa.gov/. MAS model output is
    ...
    1.  Title=Transpolar convection and magnetospheric ring current relations: real time
    ...
    1.  Title=Markov Chain-based Stochastic Modeling of Deep Signal Fading: Availability
    ...
    1.  Title=Observations from NOAA's Newest Solar Proton Sensor
    ...
    Keywords found: CDAWeb, OMNI
    Sample usage= ADNET, NASA GSFC; both via CDAWeb at
    https://cdaweb.gsfc.nasa.gov/index.html/). NASA GSFC; both
    Sample usage= OMNI >10 MeV proto OMNI >10

    1.  Title=A Multi-purpose Heliophysics L4 Mission
    ...
    Sample usage= Space Physics Data Facility https:// spdf .gsfc.nasa.gov. Space Physics Data
    Facility
    Sample usage= figure are available at the Space Physics Data Facility
    https://spdf.gsfc.nasa.gov. Space Physics Data Facility

    1.  Title=Multi-year statistics of LEO energetic electrons as observed by the Korean
    NextSat-1
    ...
    (https://omniweb.gsfc.nasa.gov/). Administration (NASA) OMNIWeb
    (https://omniweb.gsfc.nasa.gov/).

    1.  Title=The influence of spacecraft latitudinal offset on the accuracy of corotation
    forecasts
    ...
    the OMNI
    Sample usage= OMNI data are obtained from OMNIWeb (omniweb.gsfc.nasa.gov). .gov). One-hour
    OMNI data
    Sample usage= et al., 1998) or the OMNI data set (Vokhmyanin (Kaiser et
    Sample usage= We are grateful to the Space Physics Data Facility and National Space
    Science Data

    1.  Title=Evaluating Auroral Forecasts Against Satellite Observations
    ...
    Keywords found: CDAWeb
    Sample usage= data is archived at: https:// cdaweb .gsfc.nasa.gov/pub/data/image/fuv/.
    IMAGE FUV data is

    1.  Title=Quantifying Contributions of External Drivers to the Global Ionospheric State
    ...
    AP/). For
    Sample usage= obtain OMNI hourly-averaged data (https:// spdf
    .gsfc.nasa.gov/pub/data/omni/), including the interplanetary magnetic
    Sample usage= The authors gratefully acknowledge NASA/GSFC's Space Physics Data Facility
    and Dr. Natalia Papitashvili for

    1.  Title=Forecasting the Probability of Large Rates of Change of the Geomagnetic Field in
    ...
    Sample usage= use the OMNI database (http://nssdc.gsfc.nasa.gov/omniweb /). To produce the
    OMNI
    Sample usage= the data, we use the OMNI database L1. To maximize the
    Sample usage= use the OMNI database (http:// nssdc .gsfc.nasa.gov/omniweb/). To produce
    the OMNI
    Sample usage= acknowledge and thank NASA GSFCs Space Physics Data Facility'sOMNIWeb We
    acknowledge and

    1.  Title=Potential of regional ionosphere prediction using a long short-term memory
    ...
    Sample usage= from the OMNI web (https:// omniweb .gsfc.nasa.gov/ow.html). For the
    ionosonde data,
    ...
    1.  Title=Geomagnetically Induced Currents at Middle Latitudes: 1. Quiet-time Variability
    ...
    1.  Title=Worst-Case Severe Environments for Surface Charging observed at LANL satellites
    ...
    Keywords found: OMNIWeb
    Sample usage= OMNIWeb (http://omniweb.gsfc.nasa.gov/) was used, so, Ey

    1.  Title=Magnetic signatures of ionospheric disturbance dynamo for CME and HSSWs
    generated storms
    ...
    Keywords found: OMNIWeb, 
    Sample usage=) via OMNIWEB data center (https://omniweb.gsfc.nasa.gov/) via

    1.  Title= Forecasting Ultra-relativistic Electrons inside Earth-s Outer Radiation Belt
    ...
    1.  Title=Historical reconstruction of astronaut cancer risk - context for recent solar
    minima
    ...
    (https://spdf.gsfc.nasa.gov/pub/data/omni) is ~24% lower
    Sample usage= Flight Center OMNIweb interface (https://spdf.gsfc.nasa.gov/pub/data/ omni )
    is ~24% lower over
    Sample usage= Flight Center OMNIweb interface (https:// spdf .gsfc.nasa.gov/pub/data/omni)
    is ~24% lower over

    1.  Title=Development and Validation of Precipitation Enhanced Densities for the Empirical
    ...
    Sample usage= from the OMNI database; https:// cdaweb .gsfc.nasa.gov/index.html/).
    electrojet (AE) indices taken
    Sample usage= (AE) indices taken from the OMNI database;
    https://cdaweb.gsfc.nasa.gov/index.html/). electrojet (AE) indices
    Sample usage= at https://ccmc.gsfc.nasa.gov/ modelweb /models/nrlmsise00.php. The IRI-2016
    model is
    ...
    1.  Title=Solar Origins of 26th August 2018 Geomagnetic Storm: Responses of the
    ...
    Keywords found: OMNIWeb
    Sample usage= data were obtained at https// omniweb .gsfc.nasa.gov/hw/hmtl. In our recent
    paper;

    1.  Title=Responses of the African and American Equatorial Ionization Anomaly (EIA) to
    ...
    Keywords found: OMNIWeb
    Sample usage= (http:// omniweb .gsfc.nasa.gov/form/dx1.html). All days with Kp

    1.  Title=TEC Map Completion Through a Deep Learning Model: SNP-GAN
    Authors=Yang Pan; Mingwu Jin; Shunrong Zhang; Yue Deng;
    article=2021SW002810; doi=10.1029/2021SW002810; pubdate=22 October 2021
    Keywords found: CDAWeb
    Sample usage= MIT-TEC and IGS-TEC (https:// cdaweb .gsfc.nasa.gov/pub/data/gps/). The raw
    MIT-TEC maps

    1.  Title=Empirical Modeling of Ionospheric Current Using Empirical Orthogonal Function
    ...
    (https://omniweb.gsfc.nasa.gov/form/dx1.html). The Helmholtz

    1.  Title=Predicting CMEs Using ELEvoHI With STEREO-HI Beacon Data
    ...
    Keywords found: CDAWeb
    Sample usage= data: STEREO: https://stereo-ssc.nascom.nasa.gov/pub/; Wind: https:// cdaweb
    .gsfc.nasa.gov/index.html/. In situ data: STEREO:

    1.  Title=Observations of Unusual Daytime Range Spread F at Middle Latitude During the
    Afternoon Hours
    ...
    Keywords found: OMNIWeb, SPDF
    Sample usage= from the following websites http:// omniweb .gsfc.nasa.gov/ this study.
    These data
    Sample usage= ACE solar wind parameters through SPDF , NASA, wind parameters through

    1.  Title=Machine Learning for Predicting the Bz Magnetic Field Component From Upstream in
    ...
    Keywords found: SPDF
    Sample usage= from https://stereo-ssc.nascom.nasa.gov (STEREO) and https:// spdf
    .gsfc.nasa.gov/pub/data/wind/ (Wind). In this study,

    1.  Title=Relativistic Electron Model in the Outer Radiation Belt Using a Neural Network
    Approach
    ...
    Keywords found: OMNIWeb, OMNI
    Sample usage= set at 1min resolution (https:// omniweb .gsfc.nasa.gov/) are used as input
    Sample usage= geomagnetic indices obtained from the OMNI data set at 1min resolution

    1.  Title=Modeling of Ultraviolet Aurora Intensity Associated With Interplanetary and
    ...
    Sample usage= Polar UVI and OMNIWeb nasa.gov/index.html/) and OMNIWeb Plus for
    Sample usage= are derived from the NASA OMNI . speed (Vp), and the

    1.  Title=Using Unsupervised and Supervised Machine Learning Methods to Correct Offset
    ...
    1.  Title=Global-Scale Ionospheric Tomography During the March 17, 2015 Geomagnetic Storm
    ...
    1.  Title=MHD-Test Particles Simulations of Moderate CME and CIR-Driven Geomagnetic Storms
    at Solar Minimum
    ...
    1.  Title=Comparison of a Neutral Density Model With the SET HASDM Density Database
    ...
    Keywords found: CDAWeb
    Sample usage= the NASA archives at https:// cdaweb .gsfc.nasa.gov/pub/data/ace. The solar
    indices level

    1.  Title=Solar EUV-Enhancement and Thermospheric Disturbances
    Authors=C. Briand; K. Doerksen; F. Deleflie;
    article=2021SW002840; doi=10.1029/2021SW002840; pubdate=22 November 2021
    Keywords found: CDAWeb, OMNI
    Sample usage= Neutral density data from: CDAWEB : https://cdaweb.sci.gsfc.nasa.gov/index.
    Neutral density data
    Sample usage= density were also checked from OMNI database. To ensure a low

    1.  Title=Occurrence and Variations of Middle and Low Latitude Sporadic E Layer
    ...
    Keywords found: OMNIWeb
    Sample usage= and solar activity index (http:// omniweb .gsfc.nasa.gov/). solar activity
    index (http://omniweb.gsfc.nasa.gov/).

    1.  Title=Impact angle control of local intense dB/dt variations during shock-induced
    substorms
    ...
    1.  Title=The prediction of day-to-day occurrence of low latitude ionospheric strong
    ...
    Keywords found: OMNIWeb, OMNI
    Sample usage= obtained from the OMNI (https:// omniweb .gsfc.nasa.gov/ow_min.html). All
    the data used
    Sample usage= data was obtained from the OMNI (https://omniweb.gsfc.nasa.gov/ow_min.html).
    All the data used

    1.  Title=Radiation Belt Model Including Semi-Annual Variation and Solar Driving
    (Sentinel)
    ...
    1.  Title=A study of the performances of widely used external magnetic field models in the
    ...
    Sample usage= via OMNI2 datasets at http:// cdaweb .gsfc.nasa.gov. at
    http://cdaweb.gsfc.nasa.gov. T02 uses
    Sample usage= these data are available via OMNI2 datasets Geosciences and the World

    1.  Title=Ionospheric Disturbances Observed From a Single GPS Station in Hong Kong During
    ...
    Keywords found: OMNIWeb
    Sample usage= including the geomagnetic indices (https:// omniweb .gsfc.nasa.gov/ indices
    (https://omniweb.gsfc.nasa.gov/form/dx1.html) and

    1.  Title=Multi instrument Investigation of the impact of the Space Weather events of 6-10
    September 2017
    ...
    Sample usage= obtained at . The OMNI data were acquired at https://omniweb.gsfc.nasa.gov.
    Sample usage= data were downloaded from https://omniweb.gsfc.nasa.gov/ ftpbrowser
    /goes13_14_flux_5m.html. The magnetometer data utilized
    Sample usage= parameters were obtained from the SPDF OMNIWeb Database. obtained from the

    1.  Title=High-Latitude Electrodynamics Specified in SAMI3 Using AMPERE Field-Aligned
    Currents
    ...
    Keywords found: OMNIWeb
    Sample usage= indices were obtained from https:// omniweb . noaa.gov, and Solar

    1.  Title=Development of a High-Latitude Convection Model by Application of Machine
    ...
    1.  Title=Sensitivity of Ground Magnetometer Array Elements for GIC Applications I:
    ...
    1.  Title=Evidence From Galactic Cosmic Rays That the Sun Has Likely Entered a Secular
...
for 2021**
    ...
    Sample usage= NASA OMNI Web page (https:// omniweb .gsfc.nasa.gov/form/dx1.html) and the
    Dst and 
    Sample usage= is obtained from the NASA OMNI Web page
    (https://omniweb.gsfc.nasa.gov/form/dx1.html) and the 
    ...
    Sample usage= via the NSSDC CDAWEB facility at:
    https://cdaweb.gsfc.nasa.gov/cdaweb/index.html. Clus- 
    Sample usage= from the OMNI source (https:// omniweb .gsfc.nasa.gov/form/omni min.html) in
    the form 
    Sample usage= loaded from the OMNI source (https://omniweb.gsfc.nasa.gov/form/omni
    min.html) in the 
    Sample usage= via the NSSDC CDAWEB facility at:
    https://cdaweb.gsfc.nasa.gov/cdaweb/index.html. Clus- 
    Sample usage= were obtained from the SPDF OMNIWEB at: https://omniweb.gsfc.nasa.gov (R.
    McGuire, 
    ...
    Sample usage= Coordinated Data Analysis Web ( CDAWeb , https://cdaweb.gsfc.nasa.gov/) and
    the Chinese 
    Sample usage= data are found online (https:// spdf .gsfc.nasa.gov/); The data analysis
    software 
    ...
    Keywords found: CDAWeb, OMNI
    Sample usage= IMF data are from NASA CDAWeb OMNI datasets (https://cdaweb.gsfc.nasa.gov/).
    This work 
    ...
    Keywords found: OMNIWeb
    Sample usage= index is provided by the OMNIWeb (https://omniweb.gsfc.nasa.gov/).
    ...
    Keywords found: CDAWeb, OMNI
    Sample usage= tained from the CDAWeb (http://www.cdaweb.sci.gsfc.nasa.gov). The CDAWeb
    also pro- 
    ...
    Keywords found: SPDF
    Sample usage= used here, obtained from https:// spdf .sci.gsfc.nasa.gov/pub/data/rbsp. 
    ...
    Sample usage= Space Physics Data Facility (https:// spdf .gsfc.nasa.gov/). The COSMIC
    radio occultation 
    ...
    Keywords found: OMNIWeb
    Sample usage= indices can be downloaded from OMNIWeb (https://omniweb.gsfc.nasa.gov). HWs
    work is sponsored 
    ...
    (https://cdaweb.gsfc.nasa.gov/index.html/). The 
    ...
    Keywords found: SPDF
    Sample usage= Space Physics Data Facility (https:// spdf .gsfc.nasa.gov/pub/data/crres/),
    ...
    Keywords found: SPDF
    Sample usage= are openly availability at https:// spdf .sci.gsfc.nasa.gov/.
    Acknowledgments 
    ...
    Sample usage= Coordinated Data Analysis Web (https:// cdaweb . gsfc.nasa.gov) and found a 
    ...
    Keywords found: OMNIWeb, VITMO
    Sample usage= IGRF for Epoch 2015 (https:// omniweb .gsfc.nasa.gov/vitmo/cgm.html)
    Geographic 
    Sample usage= IGRF for Epoch 2015 (https://omniweb.gsfc.nasa.gov/ vitmo /cgm.html)
    Geographic 
    ...
    Keywords found: CDAWeb, OMNI
    Sample usage= can be accessed online (https:// cdaweb .gsfc.nasa.gov/cdaweb/istp_public/).
    The DMSP data set 
    ...
    (https://omniweb.gsfc.nasa.gov). The availability of data 
    Sample usage= data are available at NASA/GSFC'S Space Physics Data Facility 's OMNIWeb
    (https://omniweb.gsfc.nasa.gov). The availability 
    ...
    Keywords found: OMNIWeb
    Sample usage= obtained from the website https:// omniweb .gsfc.nasa.gov/ The indices
    Sym-H, Bz, 
    ...
    Sample usage= can be obtained under https://ccmc.gsfc.nasa.gov/ modelweb
    /models/msis_vitmo. php. All the other 
    Sample usage= https://ccmc.gsfc.nasa.gov/ modelweb /models/msis_vitmo. php. All
    ...
    Keywords found: CDAWeb
    Sample usage= Allen Probes Science Gateway https:// cdaweb .sci.gsfc.nasa.gov/. Van Allen
    Probes PSD 
    ...
    Keywords found: OMNIWeb
    Sample usage= data were obtained from http:// omniweb .gsfc.nasa.gov/form/ omni_min.html.
    Figure1 shows the 
    ...
    Sample usage= omniweb .gsfc.nasa.gov/vitmo/msis_vitmo.html) and the electron and 
    Sample usage= from the IRI model (http://ccmc.gsfc.nasa.gov/ modelweb
    /models/iri_vitmo.php). The EUV flux was 
    Sample usage= omniweb.gsfc.nasa.gov/ vitmo /msis_vitmo.html) and the electron and 
    ...
    Keywords found: CDAWeb, OMNI
    Sample usage= data was downloaded from https:// cdaweb .gsfc.nasa.gov/sp
    ...
    .sci.gsfc.nasa.gov/cgibin/eval2.cgi). First, we identified the 
    ...
    Keywords found: CDAWeb
    Sample usage= (https:// cdaweb .gsfc.nasa.gov/index.html/). We choose GPS products 
    ...
    gov/istp_public/data//noaa/noaa18/ 
    ...
    Sample usage= ( CDAWeb ) 
    Sample usage= were obtained from the GSFC/SPDF OMNIWeb interface at
    http://omniweb.gsfc.nasa.gov. The tables 
    Sample usage= were obtained from the GSFC/ SPDF OMNIWeb interface at
    http://omniweb.gsfc.nasa.gov. The 
    ...
    Keywords found: ModelWeb, VITMO
    Sample usage= due to chemical reactions. https://ccmc.gsfc.nasa.gov/ modelweb
    /models/iri2016 vitmo.php
    https://ccmc.gsfc.nasa.gov/modelweb/models/msisvitmo.php 
    Sample usage= due to chemical reactions.
    ...
    Keywords found: CDAWeb, OMNI
    Sample usage= 1-min resolution OMNI data (http:// cdaweb .gsfc.nasa.gov/cdaweb/istp
    public), the solar wind 
    Sample usage= (a), based on 1-min resolution OMNI data
    (http://cdaweb.gsfc.nasa.gov/cdaweb/istp public), the solar 
    ...
    Keywords found: CDAWeb, 
    Sample usage= global GPS TEC maps (https:// cdaweb .gsfc.nasa.gov/). Such an enhancement
    in 
    ...
    Keywords found: OMNIWeb, OMNI
    Sample usage= from OMNI web database (https:// omniweb .gsfc.nasa.gov). Acknowledgments 
    ...
    Keywords found: CDAWeb, OMNI, SPDF
    Sample usage= use of OMNI data from CDAweb using https://cdaweb.sci.gsfc.nasa.gov. 
    Sample usage= to calculate the ellipticity. The OMNI data set provided the solar 
    Sample usage= study is available from https:// spdf .gsfc.nasa.gov/pub/data/rbsp. We also
    acknowledge the 
    ...
    Keywords found: CDAWeb
    Sample usage= Coordinated Data Analysis web (https:// cdaweb .gsfc.nasa.gov/index.html/).
    ...
    Keywords found: OMNIWeb, OMNI
    Sample usage= from the OMNI database (https:// omniweb .gsfc.nasa.gov/). The data used in 
    Sample usage= from the OMNI database (https://omniweb.gsfc.nasa.gov/). The data used 
    ...
    Keywords found: OMNIWeb, OMNI
    Sample usage= from the OMNI database (http:// omniweb .gsfc.nasa.gov ). Based on previous 
    Sample usage= resolution were taken from the OMNI database (http://omniweb.gsfc.nasa.gov
    ). Based on 
    ...
    https://cdaweb.gsfc.nasa.gov/index.html. (CDAWeb):
    https://cdaweb.gsfc.nasa.gov/index.html. Acknowledgments 
    ...
    Sample usage= data (https://omniweb. gsfc.nasa.gov/ and ftps:// spdf
    .gsfc.nasa.gov/pub/data/omni). Acknowledgments 
    ...
    Sample usage= service, and OMNI data (https:// spdf .gsfc.nasa.gov/pub/data/omni/). The
    Dst and AE 
    ...
    Keywords found: OMNIWeb, OMNI
    Sample usage= King and Papitashvili, 1994; https:// omniweb .gsfc.nasa.gov.  for
    ...
    Keywords found: SPDF, Space Physics Data Facility
    Sample usage= Space Physics Data Facility (https:// spdf .gsfc.nasa.gov/). The Ledong,
    Wuhan and 
    Sample usage= soon be available at the Space Physics Data Facility
    (https://spdf.gsfc.nasa.gov/). The Ledong, Wuhan and 
    ...
    Keywords found: OMNIWeb
    Sample usage= discussion. The authors thank the OMNIweb (http://omniweb.gsfc.nasa.gov/)
    ...
    Sample usage= Available at: https://ccmc.gsfc.nasa.gov/ modelweb /models/nrlmsise00.php
    (Picone et al., 2002) 
    Sample usage= Available at: https://ccmc.gsfc.nasa.gov/modelweb/models/iri2016 vitmo .php
    (Bilitza et al., 2017) 
    ...
    Keywords found: CDAWeb
    Sample usage= Coordinated Data Analysis Web ( CDAWeb ) at https://cdaweb.gsfc.nasa.gov.
    The AE, 
    ...
    Keywords found: OMNIWeb, OMNI
    Sample usage= data are obtained from the OMNIWeb (http://omniweb.gsfc.nasa.gov/). The OMNI
    database is 
    Sample usage= from the OMNIWeb (http://omniweb.gsfc.nasa.gov/). The OMNI database is
    ...
    Keywords found: CDAWeb
    Sample usage= Coordinated Data Analysis Web ( CDAWeb ) archive at
    https://cdaweb.gsfc.nasa.gov/ Data 
    ...
    Keywords found: OMNIWeb, OMNI
    Sample usage= OMNI database (htt ps : omniweb .gs f c.nasa.gov) and World 
    Sample usage= from OMNI database (htt ps : omniweb.gs 
    ...
    Keywords found: CDAWeb
    Sample usage= are available at CDAWeb (http://cdaweb.gsfc.nasa.gov/istp_public/). The
    solar wind plasma 
    ...
    Keywords found: SPDF, Space Physics Data Facility
    Sample usage= Space Physics Data Facility (http:// spdf .gsfc.nasa.gov/). are downloaded
    from NASAs 
    Sample usage= paper are downloaded from NASAs Space Physics Data Facility
    (http://spdf.gsfc.nasa.gov/). are downloaded from NASAs 
    ...
    Keywords found: CDAWeb
    Sample usage= were downloaded from NASA (https:// cdaweb
    .gsfc.nasa.gov/cgi-bin/eval1.cgi). data were downloaded from 
    ...
    (https://omniweb.gsfc.nasa.gov/). Data Facility's OMNIWeb 
    ...
    Keywords found: CDAWeb
    Sample usage= are available on the NASA CDAWeb website: https://cdaweb.sci.gsfc.nasa.gov/.
    and PSP data 
    ...
    Keywords found: SPDF
    Sample usage= available from the website: https:// spdf .gsfc.nasa.gov/pub/data/rbsp/.
    from the website:
    ...
    Keywords found: CDAWeb, Space Physics Data Facility
    Sample usage= Coordinated Data Analysis Web (https:// cdaweb .gsfc.nasa.gov) for Van Allen
    Probes; 
    Sample usage= NASA Goddard Space Flight Center Space Physics Data Facility Coordinated
    Data Analysis Web (https://cdaweb.gsfc.nasa.gov) 
    ...
    Keywords found: CDAWeb
    Sample usage= is publicly available online (https:// cdaweb .gsfc.nasa.gov/index.html/).
    The solar wind data 
    ...
    Sample usage= can be downloaded from https:// spdf .gsfc.nasa.gov/index.html has been
    shifted to 
    ...
    Keywords found: CDAWeb
    Sample usage= able at NASAs CDAWeb (https://cdaweb.sci.gsfc.nasa.gov) and the ARTEMIS able
    ...
    Sample usage= providing the OMNI data (https:// cdaweb .gsfc.nasa.gov/index.html/). data
    ...
    Keywords found: OMNIWeb, OMNI
    Sample usage= OMNI Web system at https:// omniweb .gsfc.nasa.gov/form/dx1.html. Since the
    variation of 
    Sample usage= indices are obtained from the OMNI Web system at
    https://omniweb.gsfc.nasa.gov/form/dx1.html. Since 
    ...
    http://omniweb.gsfc.nasa.gov/). Refer ences 
    ...
    Sample usage= of the OMNI database (http:// omniweb .gsfc.nasa.gov/). For this range of 
    ...
    Sample usage= at the NASA OMNIWeb (http:// cdaweb .gsfc.nasa.gov). geomagnetic activity
    indices are 
    Sample usage= publicly available at the NASA OMNIWeb (http://cdaweb.gsfc.nasa.gov).
    ...
    Keywords found: CDAWeb
    Sample usage= summary data available from the CDAWeb database at
    https://cdaweb.gsfc.nasa.gov/index.html/. The solar 
    ...
    Keywords found: CDAWeb
    Sample usage= data are available at https:// cdaweb .gsfc.nasa.gov/pub/data/rbsp. THEMIS
    all-sky php. EFW 
    ...
    Keywords found: OMNIWeb
    Sample usage= data are available from the OMNIWeb (https://omniweb.gsfc.nasa.gov), and the
    quiet days 
    ...
    Keywords found: CDAWeb
    Sample usage= have been taken from https:// cdaweb .gsfc.nasa.gov/index.html. KN
    cdaweb.gsfc.nasa.gov/index.html. KN acknowledges 
    ...
    Keywords found: CDAWeb
    Sample usage= can be accessed through the CDAWeb at
    https://cdaweb.sci.gsfc.nasa.gov/index.html/. The ULF Pc5 
    ...
    Keywords found: OMNIWeb, OMNI
    Sample usage= data set (retrieved from http:// omniweb .gsfc.nasa.gov) and is time-shifted
    from 
    ...
    Keywords found: CDAWeb, Space Physics Data Facility
    Sample usage= NASAs Space Physics Data Facility CDAWeb at https://cdaweb.gsfc.nasa.gov.
    CDAWeb at https://cdaweb.gsfc.nasa.gov. 
    ...
    Keywords found: OMNIWeb, OMNI
    Sample usage= the OMNI data set (https:// omniweb .gsfc.nasa.gov/).
    gov/ngdcinfo/onlineaccess.html). The SYM-H index 
    Sample usage= index was downloaded from the OMNI data set
    (https://omniweb.gsfc.nasa.gov/). gov/ngdcinfo/onlineaccess.html). The 
    ...
    Keywords found: CDAWeb
    Sample usage= coordinated Data Analysis Web ( CDAWeb
    https://cdaweb.gsfc.nasa.gov/index.html/ ). The coordinated Data 
    ...
    Keywords found: CDAWeb, OMNI
    Sample usage= acknowledge the ACE data (https:// cdaweb .gsfc.nasa.gov/ data
    (https://cdaweb.gsfc.nasa.gov/ cdaweb/istp_public/), and 
    ...
    Keywords found: CDAWeb, OMNIWeb, OMNI, SPDF
    Sample usage= data from NOAA at https:// cdaweb .gsfc.nasa.gov/istp public/data/ and OMNI
    data 
    ...
    Sample usage= and OMNI data at https:// spdf .gsfc.nasa.gov/pub/data/omni/omni cdaweb.
    Some magnetic field 
    ...
    Keywords found: CDAWeb, OMNIWeb, OMNI
    Sample usage= the SYM H index through CDAWeb /NASA (https://omniweb.gsfc.nasa.gov), and
    the World 
    Sample usage= H index through CDAWeb/NASA (https:// omniweb .gsfc.nasa.gov), and the World
    Data 
    ...
    Sample usage= AE and Dst, from https:// omniweb .gsfc.nasa.gov/ftpbrowser/ace merge.html
    for Bz and 
    Sample usage= AE and Dst, from https://omniweb.gsfc.nasa.gov/ ftpbrowser /ace merge.html
    for Bz and 
    ...
    Keywords found: SPDF
    Sample usage= https:// spdf .gsfc.nasa.gov/pub/data/mms. Cluster Data is publicly 
    ...
    Keywords found: CDAWeb
    Sample usage= through CDAWEB (https://cdaweb.gsfc.nasa.gov/cgi-bin/eval2.cgi). The
    ...
    Keywords found: OMNIWeb, OMNI
    Sample usage= data are available at https:// omniweb .gsfc.nasa.gov/. Dst and AL indices 
    ...
    Keywords found: CDAWeb
    Sample usage= of Iowa and NASA CDAWeb (https://cdaweb.gsfc.nasa.gov/index.html/). CDAWeb
    (https://cdaweb.gsfc.nasa.gov/index.html/).
    Acknowledgments 
    ...
    Keywords found: CDAWeb, OMNI
    Sample usage= Coordinated Data Analysis Web ( CDAWeb )
    (https://cdaweb.sci.gsfc.nasa.gov/index.html) and geomagnetic Coordinated 
    ...
    Keywords found: CDAWeb, OMNI
    Sample usage= obtained through cedar.openmadrigal.org, vt.superdarn.org, and cdaweb
    .gsfc.nasa.gov. The simulation data are 
    ...
    Keywords found: OMNIWeb, OMNI, SPDF
    Sample usage= OMNIWeb at https://omniweb.gsfc.nasa.gov. Support for this 
    ...
    Keywords found: CDAWeb, OMNIWeb, OMNI, Space Physics Data Facility
    Sample usage= Coordinated Data Analysis Web ( CDAWeb ) at colorado.edu/mms/sdc/public/.
    They are 
    ...
    https://cdaweb.gsfc.nasa.gov/index.html/. NASA Goddard Space 
    ...
    Keywords found: OMNIWeb
    Sample usage= Solar wind parameters are from OMNIWeb (http://omniweb.gsfc.nasa.gov): (d)
    L=5 and (c) 
    ...
    Keywords found: OMNIWeb
    Sample usage= data are obtained from the OMNIWeb interface at
    http://omniweb.gsfc.nasa.gov. The geomagnetic 
    ...
    Keywords found: OMNIWeb, VITMO
    Sample usage= magnetic data are from https:// omniweb .gsfc.nasa.gov/vitmo/cgm.html.
    ...
    Keywords found: OMNIWeb, SPDF
    Sample usage= F10.7 index (available from NASAs OMNIWeb at https://omniweb.gsfc.nasa.gov)
    is 
    Sample usage= Space Physics Data Facility (https:// spdf .gsfc.nasa.gov). GPS TEC data
    products 
    ...
    Keywords found: CDAWeb, OMNI
    Sample usage= (CDA Web (https:// cdaweb .gsfc.nasa.gov/), and the World Data 
    ...
    Keywords found: OMNIWeb, OMNI, SPDF
    Sample usage= from the OMNI website (https:// omniweb .gsfc.nasa.gov/). The present work
    concentrates 
    Sample usage= point) point downloaded from the OMNI website
    (https://omniweb.gsfc.nasa.gov/). The present work 
    Sample usage= from the OMNI website (https:// spdf
    .sci.gsfc.nasa.gov/pub/data/omni/high_res_omni/). The simulation data are 
    ...
    Keywords found: CDAWeb, OMNI, Space Physics Data Facility
    Sample usage= Space Physics Data Facility (https:// cdaweb .gsfc.nasa.gov/). The diffusion
    coefficients and 
    ...
    (https://cdaweb.gsfc.nasa.gov/). The diffusion coefficients and 
    ...
    Keywords found: OMNIWeb, OMNI
    Sample usage= online at  https:// omniweb .gsfc.nasa.gov/, respectively. The THEMIS data 
    ...
    Keywords found: CDAWeb, OMNI
    Sample usage= Center (OMNI data set, https:// cdaweb .gsfc.nasa.gov/). Figure 2 shows
    F10.7 
    Sample usage= Goddard Space Flight Center ( OMNI data set, https://cdaweb.gsfc.nasa.gov/).
    Figure 2 
    ...
    Keywords found: OMNIWeb
    Sample usage= can be found at https:// omniweb .gsfc.nasa.gov/. The authors thank the 
    ...
    Sample usage= and AL index from the OMNI database (https://omniweb.gsfc.nasa.gov). 
    ...
    Sample usage= https:// sscweb .gsfc.nasa.gov/cgi-bin/Locator.cgi) into AACGM coordinates
    are 
    Sample usage= https:// omniweb .gsfc.nasa.gov/. The software used to 
    ...
    Keywords found: CDAWeb
    Sample usage= Wind spacecraft (the website https:// cdaweb .gsfc.nasa.gov/ provides Wind
    ...
    Keywords found: CDAWeb, OMNI
    Sample usage= Coordinated Data Analysis Web (https:// cdaweb .gsfc.nasa.gov) for magnetic
    and electric 
    ...
    (https://omniweb.gsfc.nasa.gov/). Solar wind 
    ...
    Keywords found: OMNIWeb, Space Physics Data Facility
    Sample usage= Goddard Space Flight Center (https:// omniweb .gsfc.nasa.gov/). The IMF/IEF
    data are 
    ...
    Keywords found: CDAWeb
    Sample usage= can be found at the CDAWeb website https://cdaweb.gsfc.nasa.gov/index.html/
    . The AMIE 
    ...
    Keywords found: CDAWeb, OMNIWeb
    Sample usage= from https:// cdaweb .gsfc.nasa.gov/index.html/ and
    https://omniweb.gsfc.nasa.gov/. CHAMP data 
    Sample usage= from https://cdaweb.gsfc.nasa.gov/index.html/ and https:// omniweb
    .gsfc.nasa.gov/. CHAMP data and GRACE 
    ...
    Keywords found: SPDF
    Sample usage= at the following website: https:// spdf .gsfc.nasa.gov/pub/data/rbsp/. 
    ...
    Keywords found: OMNIWeb, OMNI, SPDF
    Sample usage= was obtained from the GSFC/SPDF OMNIWeb (https://omniweb.gsfc.nasa.gov). We
    thank Dr. Janet 
    ...
    Keywords found: OMNIWeb
    Sample usage= (https:// omniweb .gsfc.nasa.gov/) for providing solar wind, 
    ...
    Keywords found: OMNIWeb, OMNI, SPDF
    Sample usage= nominal bow shock nose) (https:// omniweb .gsfc.nasa.gov/) (King &
    Papitashvili, 2005) 
    ...
    Sample usage= Data Facilitys OMNIWeb service (https:// cdaweb .gsfc.nasa.gov/) and Kyoto
    world data 
    Sample usage= NASA/GSFC's Space Physics Data Facility's OMNIWeb service
    (https://cdaweb.gsfc.nasa.gov/) and Kyoto world 
    Sample usage= data is acquired from NASA/GSFC's Space Physics Data Facility'sOMNIWeb
    service (https://cdaweb.gsfc.nasa.gov/) and 
    ...
    counterclockwise, 
    Sample usage= McComas at Princeton University (dmccomas@princeton.edu). OMNI data were
    obtained from the 
    Sample usage= were obtained from the GSFC/ SPDF OMNIWeb interface at
    ...
    Sample usage= data were downloaded from ftp:// spdf .gsfc.nasa.gov/pub/data/omni/high res
    omni/ 
    ...
    Keywords found: CDAWeb, OMNI, Space Physics Data Facility
    Sample usage= providing the OMNI data (https:// cdaweb .gsfc.nasa.gov/index.html/). 
    ...
    Keywords found: CDAWeb, OMNIWeb
    Sample usage= the solar wind data (https:// cdaweb .gsfc.nasa.gov/index.html/).
    References: 
    ...
    Keywords found: CDAWeb, OMNIWeb, OMNI, Space Physics Data Facility
    Sample usage= are publicly available online (https:// cdaweb .gsfc.nasa.gov/index.html/). 
    Sample usage= resolution of 1 minute through OMNIWeb (https://
    omniweb.gsfc.nasa.gov/index.html). The radial distance 
    ...
    Keywords found: OMNIWeb, OMNI
    Sample usage= and ARTEMIS; OMNI website (https:// omniweb .gsfc.nasa.gov) for
    ...
    (http://cdaweb.sci.gsfc.nasa.gov/index.html). The authors wish to 
    ...
    precalculated 
    Sample usage= CDAWeb (https://cdaweb.gsfc.nasa.gov/) and OMNI (https:// omniweb
    .gsfc.nasa.gov/). We are specially thankful 
    ...
    Keywords found: OMNIWeb, OMNI, 
    Sample usage= from the OMNI database (https:// omniweb .gsfc.nasa.gov/) Solar proton
    events lists 
    Sample usage= data are available from the OMNI database (https://omniweb.gsfc.nasa.gov/)
    Solar proton events 
    ...
    Keywords found: CDAWeb
    Sample usage= providing the MMS data (https:// cdaweb .gsfc.nasa.gov/). The codes for the 
    ...
    Keywords found: CDAWeb
    Sample usage= field are obtained from the CDAWeb (http://cdaweb.gsfc.nasa.gov/). The
    ...
    Keywords found: OMNIWeb, OMNI
    Sample usage= by ACE satellite at http:// omniweb .gsfc.nasa.gov/ and PCN index is 
    Sample usage= greatly appreciated. We thank the OMNI Goddard Fligt Centre
    (https://omniweb.gsfc.nasa.gov/) for 
    ...
    Keywords found: OMNIWeb
    Sample usage= geomagnetic indices are provided by OmniWeb (http://omniweb.gsfc.nasa.gov/).
    ...
    Keywords found: OMNIWeb
    Sample usage= used geomagnetic indices provided by OMNIWeb.nasa.gov/) and are grateful 
    ...
    Sample usage= the proton temperature T (https:// cdaweb .gsfc.nasa.gov/) The other dataset
    employed 
    Sample usage= at https:// omniweb .gsfc.nasa.gov/ftpbrowser/bow_derivation.html ). At the
    next 
    Sample usage= at https://omniweb.gsfc.nasa.gov/ ftpbrowser /bow_derivation.html ). At the
    next 
    ...
    Keywords found: CDAWeb, OMNIWeb, OMNI
    Sample usage= Coordinated Data Analysis Web ( CDAWeb ) (https://cdaweb.gsfc.nasa.gov). All
    simulations in 
    Sample usage= on 30th June 2013 (source: omniweb .gsfc.nasa.gov) since the CIMI
    simulations 
    ...
    Keywords found: OMNIWeb, SPDF
    Sample usage= data are downloaded from https:// omniweb .gsfc.nasa.gov. 
    Sample usage= at the following website: https:// spdf .gsfc.nasa.gov/pub/data/rbsp/. The
    Psw , Kp, 
    ...
    Keywords found: CDAWeb, OMNIWeb
    Sample usage= downloaded from the website https:// cdaweb
    .gsfc.nasa.gov/pub/data/polar/uvi/uvi_level1/. We thank the Active 
    Sample usage= indices are obtained from https:// omniweb .gsfc.nasa.gov/. References 
    ...
    Keywords found: CDAWeb
    Sample usage= https:// cdaweb .sci.gsfc.nasa.gov/misc/NotesU.html#UY_COHO1HR_MERGED_MA
    G_PLASMA. 
    ...
    Sample usage= from NSSDCs OMNI database (https:// omniweb .gsfc.nasa.gov/form/dx1.html).
    The Kp values used 
    Sample usage= ap; were obtained from NSSDCs OMNI database
    (https://omniweb.gsfc.nasa.gov/form/dx1.html). The Kp values 
    ...
    Keywords found: CDAWeb, OMNI
    Sample usage= data were obtained from https:// cdaweb .gsfc.nasa.gov/index.html/. The
    TIEMD/GUVI O/N2 data 
    ...
    Keywords found: SPDF, Space Physics Data Facility
    Sample usage= Physics Data Facility at http:// spdf .gsfc.nasa.gov. The work of D.K. 
    Sample usage= be obtained online from NASAs Space Physics Data Facility at
    http://spdf.gsfc.nasa.gov. The work of 
    ...
    Keywords found: CDAWeb, OMNIWeb, OMNI
    Sample usage= used are available: ECT: https:// cdaweb .gsfc.nasa.gov/pub/data/rbsp/ 
    Sample usage= time cadence is obtained at OMNIWeb (https://omniweb.gsfc.nasa.gov/). 
    ...
    Keywords found: OMNIWeb, OMNI, Space Physics Data Facility
    Sample usage= Space Physics Data Facility (https:// omniweb .gsfc.nasa.gov). We thank the
    Jicamarca 
    ...
    (https://omniweb.gsfc.nasa.gov). We thank the Jicamarca 
    ...
    Keywords found: CDAWeb
    Sample usage= F10.7p indices are from https:// cdaweb .gsfc.nasa.gov/cdaweb/sp_phys/. 
    ...
    Keywords found: CDAWeb, OMNI, Space Physics Data Facility
    Sample usage= providing the OMNI data (https:// cdaweb .gsfc.nasa.gov/index.html/) and
    ...
    Keywords found: OMNIWeb, OMNI
    Sample usage= (LRO) dataset of NASA, http:// omniweb .gsfc.nasa.gov/form/dx1.html. The
    ...
    Keywords found: CDAWeb, OMNIWeb, OMNI
    Sample usage= obtained from CDAweb at https://cdaweb.sci.gsfc.nasa.gov/. The Python pack- 
    Sample usage= http:// omniweb .gsfc.nasa.gov/html/HROdocum.html. 
    ...
    Sample usage= data were downloaded from http:// omniweb .gsfc.nasa.gov/ow.html; the World
    Data Center 
    ...
    Keywords found: CDAWeb, OMNI
    Sample usage= OMNI data are available at CDAWeb (http://cdaweb.gsfc.nasa.gov/). We thank
    J.H. King, 
    ...
    Keywords found: CDAWeb, OMNI
    Sample usage= LANL, and ROCSAT-1 data (https:// cdaweb
    .gsfc.nasa.gov/cdaweb/istp_public/), 
    ...
    Keywords found: CDAWeb, OMNI
    Sample usage= Physics Data Facility at https:// cdaweb .sci.gsfc.nasa.gov/index.html/. The
    SME index is 
    ...
    Keywords found: CDAWeb, OMNI, Space Physics Data Facility
    Sample usage= Coordinated Data Analysis Web (https:// cdaweb .gsfc.nasa.gov/). The
    ...
    https://cdaweb.gsfc.nasa.gov/pub/data/omni/omni
    ...
    Keywords found: OMNIWeb, Space Physics Data Facility
    Sample usage= Space Physics Data Facility (https:// omniweb .gsfc.nasa.gov/) and have been
    shifted 
    Sample usage= data are taken from NASA Space Physics Data Facility
    (https://omniweb.gsfc.nasa.gov/) and have been shifted 
    ...
    Sample usage= data supplied from NASA GSFC OMNI data service at
    http://omniweb.gsfc.nasa.gov). These 
    ...
    Keywords found: OMNIWeb, OMNI
    Sample usage= obtained from NASA OMNI: https:// omniweb .gsfc.nasa.gov/ Ground GPS data
    obtained 
    Sample usage= Geophysical indices obtained from NASA OMNI : https://omniweb.gsfc.nasa.gov/
    Ground GPS data 
    ...
    Keywords found: CDAWeb
    Sample usage= paper are available from https:// cdaweb .gsfc.nasa.gov/. ACE/SWEPAM data
    are available 
    ...
    Keywords found: CDAWeb, OMNI
    Sample usage= the AL index provided by CDAWeb , NASA (cdaweb.gsfc.nasa.gov) and the 
    ...
    Keywords found: OMNIWeb
    Sample usage= panel of Figure 1 (http:// Omniweb .gsfc.nasa.gov). 
    ...
    Keywords found: CDAWeb, Space Physics Data Facility
    Sample usage= Goddard Space Flight Center (https:// cdaweb .gsfc.nasa.gov/index.html).
    ...
    Keywords found: OMNIWeb, OMNI, Space Physics Data Facility
    Sample usage= Web at https:// omniweb .gsfc.nasa.gov. The authors are grateful 
    ...
    Keywords found: CDAWeb
    Sample usage= were obtained from STA_L2_PLA_1DMAX_1MIN on CDAWeb and from Antoinette
    Galvin. As 
    ...
    Keywords found: OMNIWeb, OMNI
    Sample usage= observations from OMNI web (https:// omniweb .gsfc.nasa.gov/) showing the
    solar wind 
    ...
    Sample usage= Space Physics Data Facility (https:// cdaweb .gsfc.nasa.gov/pub/data/icon/).
    The TIEGCM winds and 
    Sample usage= Community Coordinated Modeling Center (https://ccmc.gsfc.nasa.gov/pub/
    modelweb /). RRM acknowledges support from 
    Sample usage= ICON website and NASAs Space Physics Data Facility
    (https://cdaweb.gsfc.nasa.gov/pub/data/icon/). The TIEGCM winds and 
    ...
    (https://omniweb.gsfc.nasa.gov/form/dx1.html) for providing the interplanetary 
    ...
    .gsfc.nasa.gov/html/HROdocum.html) for OMNI IMF data. 
    ...
    Keywords found: OMNIWeb
    Sample usage= on the eclipse day (https:// omniweb .gsfc.nasa.gov). The Dst index is 
    ...
    Keywords found: SPDF
    Sample usage= Physics Data Facility, repository https:// spdf
    .gsfc.nasa.gov/pub/data/rbsp/. Data 
    ...
    Keywords found: CDAWeb
    Sample usage= Coordinated Data Analysis Web, URL cdaweb .gsfc.nasa.gov. 
    ...
    Keywords found: OMNIWeb
    Sample usage= were downloaded from the https:// omniweb
    .gsfc.nasa.gov/html/omni_source.html#ind. The LIS ISS Science 
    ...
    Keywords found: CDAWeb, OMNIWeb, OMNI, Space Physics Data Facility
    Sample usage= OMNI database Available at https:// cdaweb .gsfc.nasa.gov/pub/data/omni/
    (King & Papitashvili, 2005). 
    Sample usage= NASA/GSFC's Space Physics Data Facility's OMNIWeb (or CDAWeb or ftp)
    service, 
    Sample usage= SY M H data from OMNI database Available at
    https://cdaweb.gsfc.nasa.gov/pub/data/omni/ (King 
    Sample usage= We acknowledge use of NASA/GSFC's Space Physics Data Facility'sOMNIWeb (or
    CDAWeb or 
    ...
    Keywords found: OMNIWeb, OMNI, SPDF
    Sample usage= solar wind measurement database (http:// omniweb .gsfc.nasa.gov, King &
    Papitashvili, 2005 
    Sample usage= on the basis of the OMNI database
    (https://spdf.gsfc.nasa.gov/pub/data/omni). Since changes in 
    Sample usage= of the OMNI database (https:// spdf .gsfc.nasa.gov/pub/data/omni). Since
    changes in the 
    ...
    Keywords found: OMNIWeb, SPDF, Space Physics Data Facility, 
    Sample usage= index was downloaded from the OMNIWeb database (omniweb.gsfc.nasa.gov). 
    Sample usage= Space Physics Data Facility ( SPDF , spdf.gsfc.nasa.gov). 
    ...
    Keywords found: OMNIWeb, OMNI
    Sample usage= to the OMNI database (https:// omniweb .gsfc.nasa.gov/form/dx1.html); the
    ...
    Keywords found: CDAWeb, OMNIWeb, OMNI, NSSDC, SPDF
    Sample usage= Japan) via the NSSDC CDAWEB at:
    https://cdaweb.gsfc.nasa.gov/cdaweb/index.html. Clus- 
    Sample usage= from SPDF OMNIWEB at: https://omniweb.gsfc.nasa.gov (R. McGuire, N. 
    Sample usage= IMF drivers were derived from OMNI data of upstream moni- 
    Sample usage= Japan) via the NSSDC CDAWEB at:
    https://cdaweb.gsfc.nasa.gov/cdaweb/index.html. Clus- 
    Sample usage= from SPDF OMNIWEB at: https://omniweb.gsfc.nasa.gov (R. McGuire, 
    ...
    Keywords found: SPDF, Space Physics Data Facility
    Sample usage= Space Physics Data Facility (https:// spdf .gsfc.nasa.gov). The TIE-GCM
    tidal parameters 
    ...
    Sample usage= Data facility (SPDF) at https:// cdaweb .gsfc.nasa.gov. The temporal and
    spatial 
    Sample usage= Space Physics Data facility ( SPDF ) at https://cdaweb.gsfc.nasa.gov. The
    temporal 
    Sample usage= dataset hosted at the NASA Space Physics Data Facility hosted at
    https://cdaweb.gsfc.nasa.gov. In addition 
    ...
    Keywords found: CDAWeb, OMNI
    Sample usage= available online via, http:// cdaweb .gsfc.nasa.gov/. The ion spectra were 
    Sample usage= indexes were taken from the OMNI database https://cdaweb.sci.gsfc.nasa.gov.
    ...
    Sample usage= plasmapause can be found via OMNIWeb :.gov/pub/data/omni/high res omni/. 
    Sample usage= found via OMNIWeb: .gov/pub/data/ omni /high res omni/. S. D. 
    Sample usage= , 4218. Retrieved from http:// nssdc .gsfc.nasa.gov/omniweb/ doi: 
    ...
    Sample usage= the NASA OMNI website (https:// omniweb .gsfc.nasa.gov/). We acknowledge the
    use 
    Sample usage= are obtained from the NASA OMNI website (https://omniweb.gsfc.nasa.gov/). We
    acknowledge the 
    Sample usage= acknowledge the use of NASA/GSFC's Space Physics Data Facility 's OMNIWeb
    service and OMNI 
    ...
    Keywords found: CDAWeb, 
    Sample usage= Coordinated Data Analysis Web ( CDAWeb ):
    https://cdaweb.gsfc.nasa.gov/pub/data/formosat-rocsat/formosat-2/isual/airglow/. The
    IRI model 
    ...
    Keywords found: CDAWeb
    Sample usage= Dst indices are at https:// cdaweb .gsfc.nasa.gov/cdaweb/sp_phys/. The
    ...
    (https://spdf.gsfc.nasa.gov/). The ground-based magnetometer data
    ...
    Keywords found: OMNIWeb, OMNI, Space Physics Data Facility, IRI
    Sample usage= NASA/GSFC's Space Physics Data Facility's OMNIWeb at  nasa.gov. The CHAOS 
    ...
    Sample usage= data are found online (https:// spdf .gsfc.nasa.gov/). Data analysis is
    performed 
    ...
    Keywords found: CDAWeb
    Sample usage= IMF data were obtained from CDAweb (cdaweb.gsfc.nasa.gov). The magnetic
    field of 
    ...
    Keywords found: OMNIWeb, OMNI, SPDF
    Sample usage= Data Facility (SPDF) at https:// omniweb .gsfc.nasa.gov/. The authors also
    acknowledge 
    Sample usage= study are available from the OMNI database. 
    Sample usage= Space Physics Data Facility ( SPDF ) at https://omniweb.gsfc.nasa.gov/. The
    authors 
    ...
    (https://cdaweb.sci.gsfc.nasa.gov/index.html/). NMDB data 
    ...
    Keywords found: OMNIWeb
    Sample usage= TheIMF B data were from OMNIWeb (gov/form/omni_min.html). The geomagnetic
    index 
    ...
    Keywords found: CDAWeb
    Sample usage= publicly available at the NASA CDAWeb at http://cdaweb.gsfc.nasa.gov/.
    Acknowledgments 
    ...
    Keywords found: OMNIWeb, OMNI, SPDF
    Sample usage= were obtained from the GSFC/SPDF OMNIWeb interface at
    https://omniweb.gsfc.nasa.gov. The ESRAD 
    ...
    Keywords found: CDAWeb, SSCWeb, OMNIWeb, OMNI
    Sample usage= ESA data available at https:// cdaweb .gsfc.nasa.gov/pub/data/themis/ the/
    and OMNI database 
    Sample usage= Grant 17H06140. Biswajit Ojha acknowledges SSCWeb
    (https://sscweb.gsfc.nasa.gov/) for using 
    ...
    Keywords found: OMNIWeb, OMNI, OMNI2
    Sample usage= from the OMNI2 database (http:// omniweb .gsfc.nasa.gov/). All the original
    POES/MEPED 
    ...
    (http://omniweb.gsfc.nasa.gov/). All the original 
    ...
    Keywords found: CDAWeb, OMNIWeb, OMNI, Space Physics Data Facility
    Sample usage= article are available at the CDAWeb site (http://cdaweb.sci.gsfc.nasa.gov).
    The solar wind 
    Sample usage= Center Space Physics Data Facility OMNIWeb (http://omniweb.gsfc.nasa.gov),
    ...
    (http://omniweb.gsfc.nasa.gov), and the geomagnetic 
    ...
    Keywords found: CDAWeb, OMNI
    Sample usage= the OMNI database at https:// cdaweb .gsfc.nasa.gov/cgi-bin/eval1.cgi. This
    period resembles a 
    ...
    Keywords found: SPDF
    Sample usage= Allen Probes data at https:// spdf .sci.gsfc.nasa.gov/. Acknowledgments 
    ...
    Keywords found: OMNIWeb, OMNI, SPDF, Space Physics Data Facility
    Sample usage= for providing OMNI data (https:// omniweb .gsfc.nasa.gov/), WIND
    (https://spdf.gsfc.nasa.gov/pub/data/wind/), and ACE 
    ...
    Keywords found: CDAWeb, OMNIWeb, OMNI
    Sample usage= spacecraft is obtained from https:// cdaweb .gsfc.nasa.gov/pub/data/goes/.
    The plasma density results 
    Sample usage= from the OMNI database (http:// omniweb .gsfc.nasa.gov). Data from GOES
    spacecraft 
    Sample usage= study are obtained from the OMNI database (http://omniweb.gsfc.nasa.gov).
    Data from GOES 
    ...
    Keywords found: CDAWeb
    Sample usage= spacecraft were obtained from the CDAWeb : https://
    cdaweb.gsfc.nasa.gov/index.html/. MMS data 
    ...
    Keywords found: OMNIWeb, OMNI, SPDF
    Sample usage= data available from the GSFC/SPDF OMNIWeb at https://omniweb. gsfc.nasa.gov.
    ...
    Keywords found: OMNIWeb, OMNI, Space Physics Data Facility
    Sample usage= Space Physics Data Facility (http:// omniweb .gsfc.nasa.gov) for OMNI data,
    and 
    ...
    (http://omniweb.gsfc.nasa.gov) for OMNI data, and 
    ...
    Keywords found: CDAWeb
    Sample usage= of Iowa and NASA CDAWeb (https://cdaweb.gsfc.nasa.gov/index.html/). 
    ...
    Keywords found: OMNIWeb, OMNI
    Sample usage= is publicly available at https:// omniweb .gsfc.nasa.gov/. The MMS database
    is 
    ...
    Keywords found: OMNIWeb
    Sample usage= and F10.7 come from the OMNIWeb http://omniweb.gsfc.nasa.gov. 
    ...
    Keywords found: SPDF, Space Physics Data Facility
    Sample usage= Space Physics Data Facility, https:// spdf .gsfc.nasa.gov. TEC data used in 
    Sample usage= GOLD website,  NASA's Space Physics Data Facility ,
    https://spdf.gsfc.nasa.gov. TEC data used 
    ...
    Keywords found: SPDF, Space Physics Data Facility
    Sample usage= Goddard Space Flight Center (https:// spdf .gsfc.nasa.gov/pub/data/mms/).
    Acknowledgments 
    ...
    (https://omniweb.gsfc.nasa.gov) for the 
    ...
    (https://cdaweb.gsfc.nasa.gov/index.html/). The data  
    Sample usage= were downloaded from the SPDF OmniWeb database
    (https://omniweb.gsfc.nasa.gov). The solar wind 
    Sample usage= SYM-H were downloaded from the SPDF OmniWeb database
    (https://omniweb.gsfc.nasa.gov). The solar 
    ...
    Sample usage= Coordinated Data Analysis Web ( CDAWeb )
    https://cdaweb.gsfc.nasa.gov/index.html/; satellite locations from 
    Sample usage= NASAs satellite Situation Center https:// sscweb .gsfc.nasa.gov; the AL
    index data 
    Sample usage= Space Physics Data Facility http:// omniweb .gsfc.nasa.gov/ow.html the
    Themis-B data from 
    ...
    Keywords found: CDAWeb
    Sample usage= (Feltens & Schaer,1998; Wienia,2008) (http:// cdaweb .gsfc.nasa.gov/). Each
    map contains the 
    ...
    Keywords found: CDAWeb
    Sample usage= THEMIS data are available from CDAWeb ,
    https://cdaweb.sci.gsfc.nasa.gov/index.html/. Cluster data are 
    ...
    Sample usage= and the OMNI website (https:// spdf
    .gsfc.nasa.gov/pub/data/omni/omni_cdaweb/hro_1min/). Acknowledgments 
    ...
    Keywords found: OMNI, SPDF
    Sample usage= data were obtained from https://spdf.gsfc.nasa.gov/pub/data/ omni . 
    Sample usage= data were obtained from https:// spdf .gsfc.nasa.gov/pub/data/omni. 
    ...
    Keywords found: OMNIWeb
    Sample usage= Solar Wind data available from OMNIWeb at  nasa.gov/ 
    ...
    Sample usage= the DSCOVR L2 data https:// omniweb
    .gsfc.nasa.gov/ftpbrowser/dscovr_merged.html. The solar wind parameters 
    Sample usage= the DSCOVR L2 data https://omniweb.gsfc.nasa.gov/ ftpbrowser
    /dscovr_merged.html. The solar wind parameters 
    Sample usage= AU/AL index were obtained from SPDF , NASA, USA
    (https://omniweb.gsfc.nasa.gov/form/omni_min_def.html). The 
    ...
    Keywords found: OMNIWeb
    Sample usage= (5min) data were obtained from OMNIWeb (https://omniweb. gsfc.nasa.gov/).
    Variations of (a) 
    ...
    Keywords found: CDAWeb, OMNI, Space Physics Data Facility
    Sample usage= OMNI Web service at https:// cdaweb . gsfc.nasa.gov/index.html. 
    ...
    Keywords found: CDAWeb
    Sample usage= Coordinated Data Analysis Web ( CDAWeb , http://cdaweb.gsfc.nasa.gov/). The
    ...
    Keywords found: OMNIWeb, OMNI
    Sample usage= the NASA/GSFC OMNI facility (http:// omniweb .gsfc.nasa.gov), and included
    the geomagnetic 
    ...
    (https://cdaweb.gsfc.nasa.gov/index. html/) and the 
    ...
    Keywords found: SPDF
    Sample usage= data are available from https:// spdf .gsfc.nasa.gov/pub/data/barrel/l2/.
    The data for the 
    ...
    Keywords found: CDAWeb, OMNIWeb
    Sample usage= from the NASA OMNIWeb (http:// cdaweb .gsfc.nasa.gov). Furthermore, the
    AIMOS and 
    Sample usage= are obtained from the NASA OMNIWeb (http://cdaweb.gsfc.nasa.gov).
    ...
    Keywords found: CDAWeb, OMNI, SPDF
    Sample usage= Coordinated Data Analysis Web ( CDAWeb ) (https://cdaweb.gsfc.nasa.gov). Dst
    data are 
    ...
    Keywords found: CDAWeb, OMNI
    Sample usage= Coordinated Data Analysis web (https:// cdaweb .sci.gsfc.nasa.gov/
    ...
    Sample usage= can be downloaded from https://ccmc.gsfc.nasa.gov/ modelweb
    /models/iri2012_vitmo.php. The rocket data are 
    Sample usage= Space Physics Data Facility, https:// spdf .gsfc.nasa.gov/. The m-NLP data
    can 
    Sample usage= are being archived on the Space Physics Data Facility ,
    https://spdf.gsfc.nasa.gov/. The m-NLP data 
    ...
    Keywords found: OMNIWeb
    Sample usage= Goddard Space Flight Center (https:// omniweb .gsfc.nasa.gov/) for providing
    solar wind 
    ...
    Keywords found: OMNIWeb, OMNI
    Sample usage= from the OMNI website (http:// omniweb .gsfc.nasa.gov), and geomagnetic
    indices from 
    Sample usage= solar wind data from the OMNI website (http://omniweb.gsfc.nasa.gov), and
    geomagnetic indices 
    ...
    Sample usage= Incoherent Scatter radar-E90(MSIS-E90) model (http:// omniweb
    .gsfc.nasa.gov/ vitm0/msis_vitmo.html). The altitude profile 
    Sample usage= ion and electron temperature (http://ccmc.gsfc.nasa.gov/ modelweb
    /models/iri_vitmo.php). The SOLAR 2000 model 
    ...
    Keywords found: OMNIWeb, Space Physics Data Facility
    Sample usage= NASA/GSFC's Space Physics Data Facility's OMNIWeb service (https://omniweb.
    gsfc.nasa.gov) for the 
    Sample usage= The authors acknowledge the NASA/GSFC's Space Physics Data Facility 's
    OMNIWeb service (https://omniweb. gsfc.nasa.gov) 
    ...
    Keywords found: CDAWeb, OMNIWeb, OMNI, Space Physics Data Facility
    Sample usage= Physics Data Facility's OMNIWeb (or CDAWeb or ftp) service, and OMNI 
    Sample usage= OMNI data are available at: omniweb .gsfc. nasa.gov/form/dx1.html. 
    ...
    (https://cdaweb.gsfc.nasa.gov/pub/data/wind/3dp/). Acknowledgments 
...
2021**
    ...
    Measurements and Comparison With Empirical Models Over the East African Sector”, Radio Science, vol. 56, no. 2, 2021. doi:10.1029/2019RS007037.
...
for 2021**
    ...
    the Location of the Outer Boundary of Earth's Outer Radiation Belt”, Earth and Space Science, vol. 8, no. 6, 2021. doi:10.1029/2020EA001610.

    4. de Paula, E. R., “Performance of 6 Different Global Navigation Satellite System
    Receivers at Low Latitude Under Moderate and Strong Scintillation”, Earth and Space Science, vol. 8, no. 2, 2021. doi:10.1029/2020EA001314.

\

**Science Enabled Research Papers in [Solar
Physics](https://www.springer.com/journal/11207) for 2021**
...
\
    ...
    doi:10.1007/s11207-021-01930-1.
    ...
    doi:10.1007/s11207-021-01900-7.
    ...
    doi:10.1007/s11207-021-01873-7.
    ...
    doi:10.1007/s11207-021-01843-z.
    ...
    doi:10.1007/s11207-021-01803-7.
    ...
    “Nonlinear Analysis of Radial Evolution of Solar Wind in the Inner Heliosphere”, Solar Physics, vol. 296, no. 1, 2021. doi:10.1007/s11207-021-01761-0.

\

**Science Enabled Research Papers in [Journal of Atmospheric and
Solar-Terrestrial
Physics](https://www.journals.elsevier.com/journal-of-atmospheric-and-solar-terrestrial-%0Aphysics)
for 2021**
...
\
    ...
    growth of electromagnetic ion cyclotron (EMIC) waves”, Journal of Atmospheric and Solar-Terrestrial Physics, vol. 224, 2021. doi:10.1016/j.jastp.2021.105737.
    3. Chidinma, O. E., Yan, Y.-. hua ., Yin, Z., Kingsley, O. U., and Nneka, O. F., “Impact
    of solar and geomagnetic activities on total column ozone in China”, Journal of Atmospheric and Solar-Terrestrial Physics, vol. 223, 2021.
    doi:10.1016/j.jastp.2021.105738.
    ...
    cosmic rays on October-November 2003”, Journal of Atmospheric and Solar-Terrestrial Physics, vol. 221, 2021. doi:10.1016/j.jastp.2021.105707.
    ...
    doi:10.1016/j.jastp.2021.105706.
    7. Habarulema, J. B., “A global 3-D electron density reconstruction model based on radio
    occultation data and neural networks”, Journal of Atmospheric and Solar-Terrestrial Physics, vol. 221, 2021. doi:10.1016/j.jastp.2021.105702.
    8. Bussy-Virat, C. D. and Ridley, A. J., “Estimation of the thermospheric density using
    ephemerides of the CYGNSS and Swarm constellations”, Journal of Atmospheric and Solar-Terrestrial Physics, vol. 221, 2021. doi:10.1016/j.jastp.2021.105687.
    ...
    P., “How does the magnetosphere go to sleep?”, Journal of Atmospheric and Solar-Terrestrial Physics, vol. 220, 2021. doi:10.1016/j.jastp.2021.105626.
    ...
    doi:10.1016/j.jastp.2021.105615.
    13. Alberti, T., Consolini, G., and De Michelis, P., “Complexity measures of geomagnetic
    indices in the last two solar cycles”, Journal of Atmospheric and Solar-Terrestrial Physics, vol. 217, 2021. doi:10.1016/j.jastp.2021.105583.
    14. Staszak, T., “Turbulence generated small-scale structures as PMWE formation mechanism:
    Results from a rocket campaign”, Journal of Atmospheric and Solar-Terrestrial Physics, vol. 217, 2021. doi:10.1016/j.jastp.2021.105559.
    15. Wu, M., Xu, X., Li, F., Guo, P., and Fu, N., “Plasmaspheric scale height modeling
    based on COSMIC radio occultation data”, Journal of Atmospheric and Solar-Terrestrial Physics, vol. 217, 2021. doi:10.1016/j.jastp.2021.105555.
    ...
    electric field enhancements in the formation of ion multiple-nose structures”, Journal of Atmospheric and Solar-Terrestrial Physics, vol. 216, 2021.
    doi:10.1016/j.jastp.2020.105534.
    ...
    doi:10.1016/j.jastp.2021.105592.
    19. Muñoz, V., Domínguez, M., Nigro, G., Riquelme, M., and Carbone, V., “Fractality of an
    MHD shell model for turbulent plasma driven by solar wind data: A review”, Journal of Atmospheric and Solar-Terrestrial Physics, vol. 214, 2021.
    doi:10.1016/j.jastp.2020.105524.
    20. Li, Z., Elkington, S., Hudson, M., Patel, M., Boyd, A., and Wygant, J., “Modeling
    advective transport of radiation belt electrons”, Journal of Atmospheric and Solar-Terrestrial Physics, vol. 214, 2021. doi:10.1016/j.jastp.2020.105509.
    ...
    Solar Minimum of Cycle 23/24”, Journal of Atmospheric and Solar-Terrestrial Physics, vol. 213, 2021. doi:10.1016/j.jastp.2020.105516.
    ...
    doi:10.1016/j.jastp.2020.105515.
...
**Science Enabled Research Papers in [Advances in Space
Research](https://www.journals.elsevier.com/advances-in-space-research)
for 2021**
...
\
    ...
    total electron content variation during the 21 June 2020 solar eclipse”, Advances in Space Research, vol. 68, no. 8, pp. 3435–3454, 2021. doi:10.1016/j.asr.2021.06.015.

    11. Simi, K. G., “Responses of the Indian Equatorial Ionization Anomaly to two CME-induced
    geomagnetic storms during the peak phase of solar cycle 24”, Advances in Space Research, vol. 68, no. 8, pp. 3417–3434, 2021. doi:10.1016/j.asr.2021.06.013.

    12. Feng, J., Zhang, T., Han, B., and Zhao, Z., “Analysis of spatiotemporal
    characteristics of internal coincidence accuracy in global TEC grid data”, Advances in Space Research, vol. 68, no. 8, pp. 3365–3380, 2021. doi:10.1016/j.asr.2021.06.002.
    ...
    14. Petrakou, E., “Planetary statistics and forecasting for solar flares”, Advances in Space Research, vol. 68, no. 7, pp. 2963–2973, 2021. doi:10.1016/j.asr.2021.05.034.
    ...
    Electron Content (TEC) using Neural Network over Anomaly Crest Region Bhopal”, Advances in Space Research, vol. 68, no. 7, pp. 2919–2929, 2021. doi:10.1016/j.asr.2021.05.027.
    ...
    Millstone Hill incoherent scatter radar and comparison with the IRI model”, Advances in Space Research, vol. 68, no. 5, pp. 2186–2203, 2021. doi:10.1016/j.asr.2020.10.025.
    ...
    September 2017: Their impacts on the TEC over 75°E longitude sector”, Advances in Space Research, vol. 68, no. 4, pp. 1825–1835, 2021. doi:10.1016/j.asr.2021.04.012.

    31. Sur, D., Ray, S., and Paul, A., “Impact of CME and HSSW driven geomagnetic storms on
    thermosphere and ionosphere as observed from mid-latitudes”, Advances in Space Research, vol. 68, no. 3, pp. 1441–1460, 2021. doi:10.1016/j.asr.2021.03.027.

    32. Oludehinwa, I. A., Olusola, O. I., Bolaji, O. S., and Odeyemi, O. O., “Nonlinear
    interdependence features in solar wind parameters influencing geomagnetic activity during
    geomagnetic storm”, Advances in Space Research, vol. 68, no. 3, pp. 1401–1424,
    2021. doi:10.1016/j.asr.2021.03.025.

    33. Kistler, M., Halekas, J., McFadden, J., and Mieth, J. Z. D., “Distribution and
    variability of plasma perturbations observed by ARTEMIS near the Moon in the terrestrial
    magnetotail”, Advances in Space Research, vol. 68, no. 1, pp. 259–274, 2021.
    doi:10.1016/j.asr.2021.03.004.

    34. Tian, X., Chai, H., Yin, X., Wang, M., Chong, Y., and Guo, Y., “Temporal and spatial
    characteristics of the ionosphere in the Qinghai-Tibet Plateau”, Advances in Space Research, vol. 68, no. 1, pp. 225–235, 2021. doi:10.1016/j.asr.2021.03.013.

    35. Poblet, F. L., Azpilicueta, F., and Lam, H.-L., “Semiannual variation in relativistic
    electron fluxes of the outer radiation belt: Phases comparison with classical hypotheses
    predictions”, Advances in Space Research, vol. 68, no. 1, pp. 170–181, 2021.
    doi:10.1016/j.asr.2021.02.038.

    36. Denisenko, P. F., Sotsky, V. V., and Maltseva, O. A., “Adaptation of the bottomside
    electron density profile of the IRI model to data of topside radiosounding”, Advancesin Space Research, vol. 67, no. 12, pp. 4078–4088, 2021.
    doi:10.1016/j.asr.2021.02.030.

    37. El-Taher, A. M. and Thabet, A. A., “The interconnection and phase asynchrony between
    the geomagnetic indices' periodicities: A study based on the interplanetary magnetic field
    polarities 1967-2018 utilizing a cross wavelet analysis”, Advances in Space Research, vol. 67, no. 10, pp. 3213–3227, 2021. doi:10.1016/j.asr.2021.02.001.

    38. Karpachev, A. T., “Equatorial anomaly according to the Interkosmos-19 data and IRI
    model: A comparison”, Advances in Space Research, vol. 67, no. 10, pp. 3202–3212,
    2021. doi:10.1016/j.asr.2021.01.053.

    39. Guharay, A., Batista, P. P., and Buriti, R. A., “Observations of a quasi-90-day
    oscillation in the MLT winds and tides over an equatorial station using meteor radar
    winds”, Advances in Space Research, vol. 67, no. 10, pp. 3125–3133, 2021.
    doi:10.1016/j.asr.2021.02.004.

    40. Chernogor, L. F., Garmash, K. P., Guo, Q., Rozumenko, V. T., Zheng, Y., and Luo, Y.,
    “Supertyphoon Hagibis action in the ionosphere on 6-13 October 2019: Results from
    multi-frequency multiple path sounding at oblique incidence”, Advances in Space Research, vol. 67, no. 8, pp. 2439–2469, 2021. doi:10.1016/j.asr.2021.01.038.

    41. Mungufeni, P., Kim, Y. H., and Ssessenga, N., “Observations of ionospheric
    irregularities and its correspondence with sporadic e occurrence over South Korea and
    Japan”, Advances in Space Research, vol. 67, no. 7, pp. 2207–2218, 2021.
    doi:10.1016/j.asr.2021.01.013.

    42. Şentürk, E., Arqim Adil, M., and Saqib, M., “Ionospheric total electron content
    response to annular solar eclipse on June 21, 2020”, Advances in Space Research,
    vol. 67, no. 6, pp. 1937–1947, 2021. doi:10.1016/j.asr.2020.12.024.

    43. Maghrabi, A., Kudela, K., Aldosari, A., Almutairi, M., and Altilasi, M., “Short-term
    periodicities in the downward longwave radiation and their associations with cosmic ray
    and solar interplanetary data”, Advances in Space Research, vol. 67, no. 5, pp.
    1672–1681, 2021. doi:10.1016/j.asr.2020.12.010.

    44. Abuelezz, O. A., “Neural network prediction of the topside electron content over the
    Euro-African sector derived from Swarm-A measurements”, Advances in Space Research,
    vol. 67, no. 4, pp. 1191–1209, 2021. doi:10.1016/j.asr.2020.11.009.

    45. González, G. de L., “Spread-F occurrence during geomagnetic storms near the southern
    crest of the EIA in Argentina”, Advances in Space Research, vol. 67, no. 3, pp.
    1058–1084, 2021. doi:10.1016/j.asr.2020.10.051.

    46. Matamba, T. M. and Habarulema, J. B., “The ionospheric response to high-intensity long
    duration continuous AE activity (HILDCAA) event (13-15 April 2005) over mid-latitude
    African region”, Advances in Space Research, vol. 67, no. 2, pp. 777–787, 2021.
    doi:10.1016/j.asr.2020.10.034.

    47. Chernigovskaya, M. A., “Longitudinal variations of geomagnetic and ionospheric
    parameters in the Northern Hemisphere during magnetic storms according to multi-instrument
    observations”, Advances in Space Research, vol. 67, no. 2, pp. 762–776, 2021.
    doi:10.1016/j.asr.2020.10.028.

    48. Birch, M. J. and Hargreaves, J. K., “Quasi-periodic ripples in the heliosphere from 1
    to 40 AU”, Advances in Space Research, vol. 67, no. 1, pp. 678–699, 2021.
    doi:10.1016/j.asr.2020.08.030.

    49. Azpilicueta, F. and Nava, B., “A different view of the ionospheric winter anomaly”,
    Advances in Space Research, vol. 67, no. 1, pp. 150–162, 2021.
    doi:10.1016/j.asr.2020.10.039.

    50. Ratovsky, K., Klimenko, M., Vasilyev, R., Klimenko, V., and Podlesnyi, A., “Vertical
    plasma transport in the ionosphere over Irkutsk during St. Patrick's Day geomagnetic
    storm: Observations and modeling”, Advances in Space Research, vol. 67, no. 1, pp.
    122–132, 2021. doi:10.1016/j.asr.2020.10.021.

    51. Gurav, O. B., Sripathi, S., and Ghodpage, R. N., “Radio and optical investigations of
    storm time evolution of post-midnight equatorial plasma bubbles (EPBs) and their drifts
    over Indian sector”, Advances in Space Research, vol. 67, no. 1, pp. 87–101, 2021.
    doi:10.1016/j.asr.2020.09.021.

    52. Yang, S., “Interplanetary magnetic field control of plasma distribution in the polar
    ionosphere”, Advances in Space Research, vol. 67, no. 1, pp. 46–55, 2021.
    doi:10.1016/j.asr.2020.08.024.

    53. Piersanti, M., “Can an impulsive variation of the solar wind plasma pressure trigger a
    plasma bubble? A case study based on CSES, Swarm and THEMIS data”, Advances in Space Research, vol. 67, no. 1, pp. 35–45, 2021. doi:10.1016/j.asr.2020.07.046.

    54. Li, W., He, C., Hu, A., Zhao, D., Shen, Y., and Zhang, K., “A new method for improving
    the performance of an ionospheric model developed by multi-instrument measurements based
    on artificial neural network”, Advances in Space Research, vol. 67, no. 1, pp.
    20–34, 2021. doi:10.1016/j.asr.2020.07.032.`;

    export default ack2021;